        ...
        <form action="{{ route('citizens.store') }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="aadhaar_number" class="form-control @error('aadhaar_number') is-invalid @enderror" value="{{ old('aadhaar_number') }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="pension_status" class="form-select">
                        <option value="None" {{ old('pension_status') == 'None' ? 'selected' : '' }}>None</option>
